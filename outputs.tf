output "further_instructions" {
  value = <<-EOT
    ...
    IP addresses to forward to: ${data.aws_route53_resolver_endpoint.dns_inbound_resolver.ip_addresses[0]}, ${data.aws_route53_resolver_endpoint.dns_inbound_resolver.ip_addresses[1]}
